            ...
            <Slider {...settings}>
              <div className="blog-card p-3">
                <div className="blog-img">
                  <img src="assets/img/blog/blog_s1_1.png" alt="X4Pay Assessoria" />
                </div>
              ...
              <div className="blog-card p-3">
                <div className="blog-img">
                  <img src="assets/img/blog/blog_s1_2.png" alt="X4Pay Assessoria" />
                </div>
                <div className="blog-content">
                  <div className="blog-meta">
                    <Link to="/blog">
              ...
              <div className="blog-card p-3">
                <div className="blog-img">
                  <img src="assets/img/blog/blog_s1_3.png" alt="X4Pay Assessoria" />
                </div>
                <div className="blog-content">
                  <div className="blog-meta">
                    <Link to="/blog">
